...
const Adminlogin = () => {
  ...
  return (<div>
      <div>
        ...
        <div style={{maxWidth: '600px', width: '90%', marginLeft: 'auto', border: '5px solid black', marginRight: 'auto', marginTop: '100px', backgroundColor: '#C4F0F5', padding: '20px', borderRadius: '10px', boxShadow: 'rgba(0, 0, 0, 0.35) 0px 5px 15px'}}>
